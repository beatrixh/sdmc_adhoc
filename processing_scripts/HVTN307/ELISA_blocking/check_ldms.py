...
# Date: 24 June 2026
# Purpose: HVTN 307 blocking ELISA data from the Haynes lab; LDMS checks only
## ---------------------------------------------------------------------------##
...
INPUT_DATA_PATH = '/trials/vaccine/p307/s001/qdata/LabData/ELISA_blocking_pass-through/uploaded_by_lab/20260629-01/HVTN 307 Blocking Master File v5.xlsx'
...
ds = pd.read_excel(INPUT_DATA_PATH, skiprows=7)
...
# pull ldms
ldms = access_ldms.pull_one_protocol('hvtn', 307)

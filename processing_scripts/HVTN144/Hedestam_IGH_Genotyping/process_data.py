...
# def main():
    ...
    additional_144 = ">" + additional['alleles in 144']['alleles in 144'] + "\n" + additional['alleles in 144']['sequence']
    additional_144 = additional_144.str.cat(sep="\n")
    ...
    in_fasta = [i[1:] for i in fasta.split("\n") if ">" in i]

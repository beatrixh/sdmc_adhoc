...
# Date: 24 June 2026
# Purpose: HVTN 300 binding ELISA data from the Haynes lab; LDMS checks only
## ---------------------------------------------------------------------------##
...
INPUT_DATA_PATH = '/trials/vaccine/p300/s001/qdata/LabData/ELISA_binding_pass-through/uploaded_by_lab/20260618-03/HVTN300 Binding Master File_v3.xlsx'
...
ds = pd.read_excel(INPUT_DATA_PATH, skiprows=3)

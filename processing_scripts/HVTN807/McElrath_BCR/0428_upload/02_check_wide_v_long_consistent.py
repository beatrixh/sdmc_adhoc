...
wide = pd.read_csv(
    savedir+"HVTN807_BCR_sequencing_regenerated_AIRR_wide_processed_2026-05-21.txt",
    sep="\t"
)

long = pd.read_csv(
    savedir+"HVTN807_BCR_sequencing_regenerated_AIRR_long_processed_2026-05-21.txt",
    sep="\t"
)
...
wide_to_long = wide_to_long.reset_index()
